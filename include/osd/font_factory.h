...
public:
  ...
  void DrawYuvMapWCharEx(uint8_t *buffer, int buf_w, int buf_h,
                         const wchar_t wch);
  void DrawYuvMapWCharEx_my(uint8_t *buffer, int buf_w, int buf_h,
                         const wchar_t wch, uint8_t color_index_font, uint8_t color_index_bg);

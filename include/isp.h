...
int rk_isp_init(int cam_id, char *iqfile_path, int MultiCam, rk_aiq_working_mode_t work_mode);
...
int rk_isp_set_exposure_range(int cam_id, const char *mins, const char *maxs);
int rk_isp_get_exposure_range(int cam_id,  char * min_value, char* max_value);
int rk_isp_set_exposure_gain_range(int cam_id, int min, int max);
int rk_isp_get_exposure_gain_range(int cam_id, int *min_value, int *max_value) ;
...
// add by he
void * rk_isp_get_context_ptr(int cam_id);
